...
#cargar las jornadas
ronda_df <- read_csv(
  "https://raw.githubusercontent.com/IvoVillanueva/BOXSCORES-EUROLEAGE-2025_26/refs/heads/main/data/gamecodes_euroleague_2025-26.csv",
...
gamecode <- ronda_df %>%
  ...
  filter(date <= tomorrow(tzone = "Europe/Madrid")) %>%
  pull(gamecode)
